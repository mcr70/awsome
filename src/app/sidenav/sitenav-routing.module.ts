...
import { CloudfrontComponent } from './cloudfront/cloudfront.component';
...
export const routes: Routes = [
    ...
    { path: 'cloudfront', component: CloudfrontComponent, canActivate: [authGuard] },
    ...
    { path: 'rds', component: RdsComponent, canActivate: [authGuard] },
